        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <a href="/driving-license" className="hover:scale-105 transition-transform duration-300 hover:shadow-lg">
                        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 text-left">
                                    Everything about Driving License, violations...
                                </p>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="/vehicle-license" className="hover:scale-105 transition-transform duration-300 hover:shadow-lg">
                        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                            <div className="p-6">
                                <img
                                    src={VehicleLicense}
                                ...
                                />
                                <h2 className="text-2xl font-bold text-gray-900 mb-2 text-left">
                                    About Vehicle Licenses
                                </h2>
                                <p className="text-gray-600 text-left">
                                    Everything about Vehicle License, violations...
                                </p>
                            </div>
                        </div>
                    </a>
...
export default TrafficUnitSystemPage;